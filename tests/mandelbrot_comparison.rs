...
fn generate_moca_code(max_iter: i32) -> String {
    ...
    code.push_str("    let cy = y_min;\n");
    code.push_str("    let py = 0;\n");
    code.push_str("    while py < height {\n");
    code.push_str("        let cx = x_min;\n");
    code.push_str("        let px = 0;\n");
    code.push_str("        while px < width {\n");
    code.push_str("            let zr = 0.0;\n");
    code.push_str("            let zi = 0.0;\n");
    code.push_str("            let iter = 0;\n\n");
